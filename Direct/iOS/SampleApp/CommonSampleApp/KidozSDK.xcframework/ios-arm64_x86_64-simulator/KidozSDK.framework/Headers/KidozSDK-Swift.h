...
@protocol KidozInterstitialDelegate
- (void)onInterstitialAdLoadedWithAd:(InterstitialAd * _Nonnull)ad;
- (void)onInterstitialAdFailedToLoadWithError:(KidozError * _Nonnull)error;
- (void)onInterstitialAdShownWithAd:(InterstitialAd * _Nonnull)ad;
- (void)onInterstitialAdFailedToShowWithError:(KidozError * _Nonnull)error;
- (void)onInterstitialImpression;
- (void)onInterstitialAdClosedWithAd:(InterstitialAd * _Nonnull)ad;
@end
...
@protocol KidozRewardedDelegate
- (void)onRewardedAdLoadedWithAd:(RewardedAd * _Nonnull)ad;
- (void)onRewardedAdFailedToLoadWithError:(KidozError * _Nonnull)error;
- (void)onRewardedAdShownWithAd:(RewardedAd * _Nonnull)ad;
- (void)onRewardedAdFailedToShowWithError:(KidozError * _Nonnull)error;
- (void)onRewardReceivedWithAd:(RewardedAd * _Nonnull)ad;
- (void)onRewardedImpression;
- (void)onRewardedAdClosedWithAd:(RewardedAd * _Nonnull)ad;
@end
