...
If you don't have the [External Dependency Manager](https://github.com/googlesamples/unity-jar-resolver) already integrated in your project, please download and import [external-dependency-manager-1.2.177.unitypackage](/Kidoz/Unity/external-dependency-manager-1.2.177.unitypackage) into your project. 

Download and import [KidozUnityPlugin.unitypackage](/Kidoz/Unity/KidozUnityPlugin.unitypackage) into your project's Asset Folder.



## Using the SDK

See full usage example on our [Sample app Main scene script](/Kidoz/Unity/SampleApp/Assets/Scenes/MainCode.cs)
